...
*/
QColor ColorPicker::color(int index) const
{
...
/*!
    ...
    \sa insertColor()
*/
void ColorPicker::setStandardColors()
{
...
/*!
    ...
    top to bottom.
*/
void ColorPicker::insertColor(const QColor &color, const QString &text, int index)
{
...
*/
void ColorPicker::setColorDialogEnabled(bool enabled)
{
    withColorDialog = enabled;
}
bool ColorPicker::colorDialogEnabled() const
{
...
/*!
    ...
    \endcode
*/
QColor ColorPicker::getColor(const QPoint &point, bool allowCustomColors)
{
